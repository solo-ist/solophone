...
| Review (own build, 2026-09-13) | 0.2.0 | `com.soloist.review` | local: `~/Code/readwise-review` (light-sdk scaffold) | lightsdk-dev key (checked into light-sdk) | built + installed from source |
